...
<head>
    ...
    <title>MOBIE - View Product</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            category.category_name FROM product JOIN category ON product.product_category = category.category_id";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	?>
                                                        <div class="item">
                                                            <img src="../uploads/<?php echo $file_array[$j];?>"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputProductPrice" type="text" name="product_price" required=""
