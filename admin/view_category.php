...
<head>
    ...
    <title>MOBIE - View Category</title>
    <!-- Bootstrap CSS -->
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <a class="dropdown-item" href="account_admin.php"><i
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../uploads/<?php echo $res['category_image'];?>"
                                                        height="100px" width="100px"></td>
                                                <td>
                                                    <button data-toggle="modal" data-target="#exampleModal"
                                                        class="btn btn-space btn-primary"
                                                        onclick="edit_cat(<?php echo $res['category_id'];?>)">Edit</button>
                                                    <button onclick="delete_cat(<?php echo $res['category_id'];?>)"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputCategoryName" type="text" name="category_name" required=""
                                        placeholder="Enter category name" autocomplete="off" class="form-control">
                                </div>
