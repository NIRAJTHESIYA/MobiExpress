    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">MobiExpress</a>
        ...
        <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="card text-center p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Your satisfaction is our priority. From pre-purchase inquiries to
                                post-purchase support, our customer service team is dedicated to providing exceptional
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="card text-center p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Embracing change and staying ahead of the curve, we are driven by a
                                passion for innovation that reflects in the products we offer.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="card text-center p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">We provide fast Services to our customers. We service in 1 hr from the
                                time customer order the product.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="item">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <a href="shop.php?category=<?php echo $res['category_id'];?>"><img class="card-img"
                                            src="uploads/<?php echo $res['category_image'];?>"></a>
                                </div>
            ...
            <div class="row m-5 hero-image2 rounded">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-3 hero-text">
                    ...
                    <p class="text-dark px-5">Behind MobiExpress is a team of dedicated professionals who share
                        a common vision – to provide you with the best-in-class products and services. Meet the faces
                        behind the brand who work tirelessly to make your smartphone journey exceptional.</p>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        Copyright © 2023 Concept. All rights reserved. Dashboard by MobiExpress Team</a>.
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
