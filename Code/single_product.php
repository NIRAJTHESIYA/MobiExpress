...
<head>
    ...
    <title>MOBIE - Product Details</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active" href="#" id="navbarDropdownMenuLink1" data-toggle="dropdown"
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pr-xl-0 pr-lg-0 pr-md-0 m-b-30">
                            <div class="product-slider p-4">
                                <div id="carouselExampleIndicators" class="product-carousel carousel slide"
                                    data-ride="carousel">
                                    <?php
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item <?php if($i == 0) {echo 'active';} ?>">
                                            <img class="d-block w-100" src="uploads/<?php echo $file_array[$i];?>"
                        ...
                        <div
                            class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30 d-flex">
